...
const Header = () => {
  ...
  return (
    ...
    <div className="pl-4 pr-4 pt-4 bg-[#DEDDE7] dark:bg-gray-900 border-b-3 border-black border-solid flex justify-between z-50 w-full fixed top-0">
        ...
        <p className='pr-20'></p>
        <p className="header-name text-5xl cursor-pointer dark:text-white" onClick={handleCloseHamburger}> <Link to="/">livingroom</Link> </p>
        <Link to="/basket">
          <div className="basket" onClick={handleBasketClick}>
            <svg className='w-10 h-10 dark:bg-white rounded-3xl pt-2 pb-1 pr-1' viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
